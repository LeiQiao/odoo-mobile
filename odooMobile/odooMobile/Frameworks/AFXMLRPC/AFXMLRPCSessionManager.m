...
{
    return [self XMLRPCRequestWithMethod:method timeout:-1 parameters:parameters];
}
...
-(id) execute:(NSString*)method timeout:(NSTimeInterval)timeout parameters:(NSArray*)parameters
{
    ...
    NSURLRequest* request = [self XMLRPCRequestWithMethod:method timeout:timeout parameters:parameters];
